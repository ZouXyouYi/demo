    ...
    return (
      <>
        {this.state.page ?
          ...
          : <div>
            <Next name={this.state.name} version={this.state.version} location={this.state.location}
              one={this.state.one} two={this.state.two} thr={this.state.thr} four={this.state.four}
              five={this.state.five} operation={this.state.operation} ></Next>
          </div>
        }
      </>
    )
